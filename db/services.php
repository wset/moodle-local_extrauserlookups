 ...
 */
 ...
 $functions = array(
        ...
        'local_extrauserlookups_update_users' => array( // local_PLUGINNAME_FUNCTIONNAME is the name of the web service function that the client will call.
                'classname'   => 'local_extrauserlookups_external', // create this class in local/PLUGINNAME/externallib.php
                'methodname'  => 'update_users', // implement this function into the above class
                'classpath'   => 'local/extrauserlookups/externallib.php',
                'description' => 'Amended user update function',
                'type'        => 'write', // the value is 'write' if your function does any database change, otherwise it is 'read'.
